...
usuarios_fantasy = [
    ('Pedro', 'Felipe', 'pedro', 'pedro@gmail.com', 'teste123',
     'teste123', 'Goku', r'C:\Users\eliel\Downloads\cosplay\goku.png'),
    ('Danilo', 'Escudeiro', 'danilo', 'danilo@gmail.com', 'teste123',
     'teste123', 'Escanor', r'C:\Users\eliel\Downloads\cosplay\escanor.jpg'),
    ('Charles', 'Passos', 'charles', 'charles@gmail.com', 'teste123',
     'teste123', 'Natsu', r'C:\Users\eliel\Downloads\cosplay\satoru.jpg'),
...
with sync_playwright() as p:
    ...
    def inscrever_fantasy():
        for usuario in usuarios_fantasy:
            ...
            sleep(2)
            pagina.click(
                'xpath=/html/body/div/div[2]/div/div/div[2]/div/div[2]/a')
            sleep(2)
